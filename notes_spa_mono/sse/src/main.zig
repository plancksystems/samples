...
pub const PLANCK_CONN: []const u8 = "127.0.0.1:24001;uid=admin;key=UGxhbmNrX0RlZmF1bHRfQWRtaW5fS2V5XzAwMTA=;tls=false";
...
pub fn main(init: std.process.Init) !void {
    ...
    try watch.start();
    log.info("notes_spa_mono_sse: watching planck at {s}", .{PLANCK_CONN});
    ...
    log.info("notes_spa_mono_sse: HTTP http://127.0.0.1:4501", .{});
    try app.run(io);
}
