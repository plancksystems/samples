...
pub fn build(b: *std.Build) void {
    ...
    const wasm = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            .imports = &.{
                ...
                .{ .name = "proto", .module = deps.proto },
                .{ .name = "bson", .module = deps.bson },
            },
        }),
    });
    wasm.entry = .disabled;
    ...
    const setup_install = b.addInstallArtifact(setup_exe, .{});
    const run_setup = b.addRunArtifact(setup_exe);
    run_setup.step.dependOn(&setup_install.step);
    ...
    b.step("setup", "Create stores + indexes for the pql-demo dataset").dependOn(&run_setup.step);
